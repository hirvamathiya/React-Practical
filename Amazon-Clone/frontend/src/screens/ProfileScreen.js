...
export default function ProfileScreen() {
    ...
    const submitHandler = (e) =>{
        ...
        {
            dispatch(updateUserProfile({userId:user._id,name,email,passowrd}));
        }
    }
                 ...
                 </div>
                 {
                     ...
                     <>
                       ...
                       <div>
                           ...
                           <input type="password" id="confirmPassword" placeholder="Enter confirm passsword" onChange={e=>setConfirmPassword(e.target.value)} />
                       </div>
